 ...
 * @param {string} child
 * @param {string} parent
 * @returns {boolean} true when `child` resolves to `parent` or anywhere under it
 */
      ...
      if (this.jsonOut) {
        ...
        try {
          ...
          try {
            ...
            consola.warn(`Could not remove the earlier ${this.jsonOut} either: ${rmError.message}`);
          }
...
module.exports = { LiquidSamplerRunner, isAbsentOrEmptyDir, isSameOrInside };
