...
class SharedPart {
  ...
  //static async addToReconciliationText(firmId, template) {}

  //static async addToExportFile(firmId, template) {}

  //static async addToAccountTemplate(firmId, template) {}

  //static async removeFromReconciliationText(firmId, template) {}

  //static async removeFromExportFile(firmId, template) {}

  //static async removeFromAccountTemplate(firmId, template) {}
  ...
  static async #processUsedIn(firmId, templateUsedIn, existingConfig) {
    ...
    for (let template of templateUsedIn) {
      ...
      const templateExistingInConfig = usedIn.findIndex(
        (existingUsedRecon) => existingUsedRecon.handle == template.handle
      );
      // Missing
