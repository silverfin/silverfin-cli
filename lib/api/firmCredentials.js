...
class FirmCredentials {
  ...
  listAuthorizedFirms() {
    ...
    return Object.keys(this.data)
      .filter((element) => !this.#RESERVED_DATA_KEYS.includes(element) && this.#isPlainObject(this.data[element]))
  ...
  #checkDefaultValues() {
    ...
    if (!hostPresent || typeof this.data.host !== "string" || this.data.host.trim() === "") {
      ...
      if (hostPresent) {
        consola.warn(`Credentials file ${this.#SF_CREDENTIALS_PATH} had an invalid host (${JSON.stringify(this.data.host)}); resetting it to the default (${this.SF_DEFAULT_HOST})`);
      }
