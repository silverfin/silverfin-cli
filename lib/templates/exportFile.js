...
class ExportFile {
  ...
  static #prepareConfigDetails(template, existingConfig) {
    ...
    // Populate missing name fields with name_nl if they're not set
    if (attributes.name_nl && !attributes.name_en) {
      attributes.name_en = attributes.name_nl;
    }
    if (attributes.name_nl && !attributes.name_fr) {
      attributes.name_fr = attributes.name_nl;
    }
    if (attributes.name_nl && !attributes.name_de) {
      attributes.name_de = attributes.name_nl;
    }
    if (attributes.name_nl && !attributes.name_da) {
      attributes.name_da = attributes.name_nl;
    }
    if (attributes.name_nl && !attributes.name_se) {
      attributes.name_se = attributes.name_nl;
    }
    if (attributes.name_nl && !attributes.name_fi) {
      attributes.name_fi = attributes.name_nl;
    }
