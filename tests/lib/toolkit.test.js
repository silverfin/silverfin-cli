...
describe("Toolkit", () => {
  ...
  describe("publishReconciliationById", () => {
    ...
    it("should return false when no template found with matching ID", async () => {
      ...
      expect(require("consola").error).toHaveBeenCalledWith(`No template found with reconciliation ID: ${mockReconciliationId}`);
    ...
    it("should return false when API call fails", async () => {
      ...
      expect(require("consola").error).toHaveBeenCalledWith(`Reconciliation update failed for ID: ${mockReconciliationId}`);
      expect(result).toBe(false);
    });
  ...
  describe("publishExportFileById", () => {
    ...
    it("should return false when no template found with matching ID", async () => {
      ...
      expect(consola.error).toHaveBeenCalledWith(`No template found with export file ID: ${mockExportFileId}`);
      expect(result).toBe(false);
    });
    ...
    it("should return false when API call fails", async () => {
      ...
      expect(consola.error).toHaveBeenCalledWith(`Export file update failed for ID: ${mockExportFileId}`);
      expect(result).toBe(false);
    });
  ...
  describe("publishAccountTemplateById", () => {
    ...
    it("should return false when no template found with matching ID", async () => {
      ...
      expect(consola.error).toHaveBeenCalledWith(`No template found with account template ID: ${mockAccountTemplateId}`);
      expect(result).toBe(false);
    });
    ...
    it("should return false when API call fails", async () => {
      ...
      expect(consola.error).toHaveBeenCalledWith(`Account template update failed for ID: ${mockAccountTemplateId}`);
      expect(result).toBe(false);
    });
  ...
  describe("publishSharedPartById", () => {
    ...
    it("should return false when no template found with matching ID", async () => {
      ...
      expect(consola.error).toHaveBeenCalledWith(`No template found with shared part ID: ${mockSharedPartId}`);
      expect(result).toBe(false);
    });
    ...
    it("should return false when API call fails", async () => {
      ...
      expect(consola.error).toHaveBeenCalledWith(`Shared part update failed for ID: ${mockSharedPartId}`);
      expect(result).toBe(false);
    });
